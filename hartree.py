...
def HartreeFock:
    __init__(self, Noble_Gas)
        self.atomic_coordinates = Noble_Gas.atomic_coordinates
        #self.gas_model = Noble_Gas...
        self.ndof = len(Noble_Gas.atomic_coordinates) * Noble_Gas.orbitals_per_atom
        self.interaction_matrix = self.calculate_interaction_matrix(self.atomic_coordinates, self.ndof, Noble_Gas.model_parameters)
        ...
        self.chi_tensor = self.calculate_chi_tensor(self.atomic_coordinates, self.ndof ,Noble_Gas.model_parameters) 
        self.hamiltonian_matrix = self.calculate_hamiltonian_matrix(atomic_coordinates, self.ndof ,model_parameters)



def calculate_interaction_matrix(atomic_coordinates, ndof, model_parameters):
...
def calculate_potential_vector(atomic_coordinates, ndof, model_parameters):
...
def calculate_chi_tensor(atomic_coordinates, ndof  ,model_parameters):
...
def calculate_hamiltonian_matrix(atomic_coordinates, ndof ,model_parameters):
...
def calculate_atomic_density_matrix(atomic_coordinates, ndof):
